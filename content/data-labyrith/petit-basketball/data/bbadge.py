def obtenir_le_badge(nom):
    """
    Renvoie une image de badge avec le nom de la personne qui a terminé le labyrinthe.
    """
    import requests
    ...
    line1_text = nom
    line2_text = 'a terminé'
    line3_text = 'le petit labyrinthe'
    line4_text = 'Data Dunkers'
    font_size = 44
    ...
    # add hashtags
    draw.text((260, 20+font_size*4+12+180), '#datadunkers', fill=(242, 103, 34), font=ImageFont.truetype(io.BytesIO(r.content), size=20))
